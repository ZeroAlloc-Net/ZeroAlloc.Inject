...
public class BasicRegistrationTests
{
    ...
    public void NoAttributedClasses_GeneratesNothing()
    {
        ...
        Assert.DoesNotContain("Error", diagnostics.AsEnumerable().Select(d => d.Severity.ToString()), StringComparer.Ordinal);
    }
    ...
    [Fact]
    public void GeneratedFile_SuppressesCS1591_SoConsumerDocGatesDoNotBreak()
    {
        // The generated ServiceCollectionExtensions is PUBLIC but intentionally
        // undocumented. A consumer that turns on GenerateDocumentationFile with
        // WarningsAsErrors;CS1591 (a doc-coverage gate) cannot pragma or annotate code
        // it does not own — and the `// <auto-generated />` marker does NOT exempt a
        // source-generator tree from CS1591 (measured downstream: it still errored on a
        // clean build). So the generated file must disable 1591 itself, as the Razor
        // generator does. Regression pin for that gap.
        var source = """
            using ZeroAlloc.Inject;
            namespace TestApp;
        ...
        Assert.Contains("#pragma warning disable 1591", output);
    }
